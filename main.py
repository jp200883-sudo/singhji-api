...
# ==========================================
# 15 Modules Import (Abhi ke liye)
# ==========================================
...
async def lifespan(app: FastAPI):
    # Startup
    logger.info("🚀 Singh Ji AI ULTRA v8.3 Shuru Ho Raha Hai...")
    await send_telegram_message("🦁 Singh Ji AI ULTRA v8.3 Started Successfully!")
    yield
    # Shutdown
    logger.info("👋 Singh Ji AI ULTRA Band Ho Raha Hai...")
    await send_telegram_message("🛑 Singh Ji AI ULTRA Shutting Down...")
...
app = FastAPI(
    ...
    version="8.3",
    description="15+ Modules, AI-Powered WhatsApp Bot",
    lifespan=lifespan
)
...
# ✅ /ping - Healthcheck endpoint (Render/Railway ke liye zaroori!)
@app.get("/ping")
async def ping():
    return {
        "status": "ok",
...
app.include_router(plant_router, prefix="/api/v1/plant-doctor")
app.include_router(telegram_bot_router, prefix="/api/v1/telegram")
...
app.include_router(news_scheduler_router, prefix="/api/v1/news-scheduler")
