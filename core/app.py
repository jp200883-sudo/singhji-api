# core/app.py — v5.0 (ALL PATHS FIXED)
...
# ✅ ALL MODULES — paths match ACTUAL folder names!
MODULES = {
    'telegram': {'name': 'Telegram Bot', 'path': 'modules.telegram_bot.handler'},      # ✅ telegram_bot
    'plant': {'name': 'Plant ID', 'path': 'modules.plant_id.handler'},                  # ✅ plant_id
    'memory': {'name': 'Supabase Memory', 'path': 'modules.supabase_memory.handler'},   # ✅ supabase_memory
    'language': {'name': 'Language Hub', 'path': 'modules.language_hub.handler'},     # ✅ language_hub
    'admin': {'name': 'Admin Panel', 'path': 'modules.adminpanal.handler'},              # ✅ adminpanal
}
